...
public class StandardTruck extends Truck{
	...
	public Branch getDestination() { return destination; }
	public String toString() { return "StandartTruck ["+ super.toString() +",maxWeight=" + maxWeight + "]"; }
	public String Additional() { return ", maxWeight=" + getMaxWeight(); }
	public boolean equals(Object object) {
		if(object == null || this.getClass() != object.getClass() || !super.equals(object))
			return false; 
		StandardTruck other = (StandardTruck)object;
		return maxWeight == other.maxWeight && destination.equals(other.destination);
	}
	public void unload () {
